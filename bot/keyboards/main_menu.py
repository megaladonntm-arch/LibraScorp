...
def build_admin_panel_menu(lang: str) -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            ...
            [KeyboardButton(text=label(lang, "premium_list")), KeyboardButton(text=label(lang, "user_profile"))],
            [KeyboardButton(text=label(lang, "ban_user")), KeyboardButton(text=label(lang, "unban_user"))],
            [KeyboardButton(text=label(lang, "broadcast_all"))],
