...
TEXTS = {
    ...
    "en": {
        ...
        "ask_slide_images": "You can now add your own slide photos.\nSend images one by one (up to {max_count}, one photo per slide).\nIf not needed: skip\nWhen finished: done",
