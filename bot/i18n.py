...
TEXTS = {
    "ru": {
        ...
        "premium_missing_openai_key": "Не настроен OPENAI_API_KEY для распознавания голоса.",
    ...
    "en": {
        ...
        "premium_missing_openai_key": "OPENAI_API_KEY is not configured for voice transcription.",
    ...
    "uz": {
        ...
        "premium_missing_openai_key": "Ovozni matnga aylantirish uchun OPENAI_API_KEY sozlanmagan.",
