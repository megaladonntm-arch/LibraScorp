...
TEXTS = {
    "ru": {
        ...
        "no_tokens": "Приложение полностью бесплатное для всех. Токены больше не нужны.",
        ...
        "ready": "Готово.\nСлайдов: {slides}\nШрифт: {font}\nЦвет: {color}\nРежим: полностью бесплатно для всех.",
        "build_error": "Ошибка при создании презентации: {error}",
        "my_tokens": "Приложение полностью бесплатное для всех. Токены не используются.",
    ...
    "en": {
        ...
        "about": "LibraScorp Presentation Studio is an AI-powered presentation builder focused on commercial quality: structured messaging, template-driven visuals, brand-safe text settings, and .pptx delivery. The app is completely free for everyone.",
        "tokens_info": "The app is completely free for everyone.",
        ...
        "no_tokens": "The app is completely free for everyone. Tokens are no longer required.",
        ...
        "ask_slide_images": "You can now add your own slide photos.\nSend images one by one (up to {max_count}, minimum 2 photos per slide).\nIf not needed: skip\nWhen finished: done",
        ...
        "ready": "Done.\nSlides: {slides}\nFont: {font}\nColor: {color}\nMode: completely free for everyone.",
        "build_error": "Failed to create presentation: {error}",
        "my_tokens": "The app is completely free for everyone. Tokens are not used.",
    ...
    "uz": {
        ...
        "about": "LibraScorp Presentation Studio — AI yordamida tijoriy uslubdagi taqdimotlar yaratish xizmati: strukturali slayd matnlari, shablon asosida dizayn va .pptx formatida tayyor eksport. Ilova hamma uchun mutlaqo bepul.",
        "tokens_info": "Ilova hamma uchun mutlaqo bepul.",
        ...
        "no_tokens": "Ilova hamma uchun mutlaqo bepul. Tokenlar endi kerak emas.",
        ...
        "ask_slide_images": "Endi slaydlarga o'zingizning rasmlaringizni qo'shishingiz mumkin.\nRasmlarni bittadan yuboring (maksimum {max_count} ta, har slayd uchun kamida 2 ta rasm).\nKerak bo'lmasa: skip\nTugatgach: done",
        ...
        "ready": "Tayyor.\nSlaydlar: {slides}\nShrift: {font}\nRang: {color}\nRejim: hamma uchun mutlaqo bepul.",
        "build_error": "Taqdimot yaratishda xatolik: {error}",
        "my_tokens": "Ilova hamma uchun mutlaqo bepul. Tokenlar ishlatilmaydi.",
